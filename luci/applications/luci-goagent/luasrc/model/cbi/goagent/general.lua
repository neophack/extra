...
o = sg:option(ListValue, "profile", translate("Profile"),
	translate("If IPv6 is selected, the \"IPv6 HTTP Settings\" and \"IPv6 Host Lists\" will be used. Otherwise the IPv4* will be used. This will only be applied in IPv6 environment."))
